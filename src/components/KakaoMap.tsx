...
import { GEOLOCATION_OPTIONS, getAccuracyLabel, getLocationErrorMessage, type LocationInfo } from '../lib/location'
  ...
  useEffect(() => {
    ...
    if (!currentLocationMarkerRef.current) {
      currentLocationMarkerRef.current = new window.kakao.maps.Marker({
        ...
        position,
        title: '내 위치',
        image: new window.kakao.maps.MarkerImage(buildCurrentLocationMarkerImageUrl(), new window.kakao.maps.Size(34, 34), { offset: new window.kakao.maps.Point(17, 17) }),
        zIndex: 100,
      })
    } else {
